"""
Hook File: trio_hook_orm.py

What it does:
Compatibility shim that re-exports the public surface of hook_orm under the trio_-prefixed name so legacy callers keep importing.

How to use it:
Do not write new code against this module; import from hook_orm directly. This file exists only to keep older imports working.

Primary entry points:
upsert_journal_contains, ensure_log_table, first_setting, log_hook
...
#
# === LLM-USAGE: END ===
# Compatibility shim — import from hook_orm instead.
from hook_orm import *  # noqa: F401,F403
