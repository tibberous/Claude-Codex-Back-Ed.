"""
Hook File: file_to_model.py

What it does:
Unified OpenAI file bridge that uploads files to model endpoints, downloads returned files, and supports screen-capture handoff to a model.

How to use it:
Use this as the general disk-file-to-model path when a workflow can save content locally before sending it to OpenAI.
